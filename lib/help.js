...
// level (plan §8). v0.3.0 makes it five, on the same reasoning: register is a
// third independent axis and any voice pairs with any level and any register.
// `--defaults` is the escape hatch for anyone who wants none of the five.
const FOOTER = 'Without flags, init asks five questions: mode, agent + scope, voice, conciseness, register.\nUse `init --defaults` to take every default and answer nothing.';
...
const COMMANDS = [
  {
    ...
    section: {
      ...
      flags: [
        ...
        ['--register slack|ste', 'how the sentences are built (ste is STE-inspired)'],
    ...
    gotcha:
      ...
      '--defaults answers every question with the value the prompt already suggests, and\n' +
      'any flag you pass alongside it still wins.',
  },
  {
    name: 'version',
