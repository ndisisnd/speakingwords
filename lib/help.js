...
const FOOTER = 'Without flags, init asks three questions: mode, agent + scope, voice.';
...
const COMMANDS = [
  ...
  },
  {
    ...
    gotcha:
      'Only hook mode counts anything. In memory mode there is no linter running, so\n' +
      'status exits 0 with one explanatory line instead of a table.',
  },
  {
    name: 'update',
  ...
  },
  {
    ...
    gotcha:
      ...
      'stay put, so a later init picks up where you left off.',
  },
  {
    name: 'help',
