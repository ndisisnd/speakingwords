...
// The shared seven. These are the lexicon Language rules (§ Language rules)
...
//
// Sycophantic openers and filler closes used to be two lines. They merged in
// v0.2.0 to make room for the conciseness line inside the 9-line budget (A1):
// both are the same rule seen from either end of a reply — no filler at the
// edges — so the merge costs a line, not a rule.
